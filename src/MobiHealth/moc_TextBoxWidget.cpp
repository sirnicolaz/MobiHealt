...
static const char qt_meta_stringdata_TextBoxWidget[] = {
    "TextBoxWidget\0"
};

const QMetaObject TextBoxWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TextBoxWidget,
      qt_meta_data_TextBoxWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TextBoxWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TextBoxWidget))
