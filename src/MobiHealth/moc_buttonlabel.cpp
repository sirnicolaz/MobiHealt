...
static const char qt_meta_stringdata_ButtonLabel[] = {
    "ButtonLabel\0\0released()\0"
};

const QMetaObject ButtonLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ButtonLabel,
      qt_meta_data_ButtonLabel, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ButtonLabel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ButtonLabel))
