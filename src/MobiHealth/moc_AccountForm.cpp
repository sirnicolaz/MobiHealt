...
static const char qt_meta_stringdata_AccountForm[] = {
    "AccountForm\0"
};

const QMetaObject AccountForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AccountForm,
      qt_meta_data_AccountForm, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AccountForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AccountForm))
